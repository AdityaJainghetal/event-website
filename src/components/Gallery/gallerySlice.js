...
// //     try {
// //       const response = await axios.get('http://localhost:8000/api/technology/category');
...
// //   async (_, { rejectWithValue }) => {
// //     try {
// //       const response = await axios.get('http://localhost:8000/api/technology/product');
// //       return response.data;
// //     } catch (err) {
...
//     try {
//       const response = await axios.get(
//         "http://localhost:8000/api/technology/product",
//       );
//       return response.data;
//     } catch (err) {
//       return rejectWithValue(
